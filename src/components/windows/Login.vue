<template>
  <div class="login">
        ...
        <div class="content">
          ...
          <div class="form">
            ...
            <div class="form-group">
              ...
              <input type="password" autofocus id="password" class="form-control" autocomplete="off" v-model="password"
    ...
    <div class="details-bar">
      <div>
        You're currently not logged in the KittenOS 95 Latest Edition.
      </div>
    </div>
    <!-- Login Error Dialog  -->
